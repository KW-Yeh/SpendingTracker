...
"[project]/src/app/analysis/ChartContainer.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ChartContainer = ({ title, children })=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "relative flex w-full flex-col items-center rounded-xl bg-white p-6 shadow-md transition-all hover:shadow-lg z-10",
        children: [
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            className: "absolute -bottom-1 left-0 h-1 w-1/2 rounded-full bg-primary-300"
                        }, void 0, false, {
                            fileName: "[project]/src/app/analysis/ChartContainer.tsx",
                            lineNumber: 15,
                            columnNumber: 11
...
"[project]/src/utils/calSpending2Chart.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/constants.ts [app-client] (ecmascript)");
;
const calSpending2Chart = (data)=>{
    const { incomeResult, totalIncome, necessaryIncome, unnecessaryIncome, outcomeResult, totalOutcome, necessaryOutcome, unnecessaryOutcome } = parseData(data);
    const { results: incomeList, necessaryList: incomeNecessaryList, unnecessaryList: incomeUnnecessaryList } = getPieChartData(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INCOME_TYPE_MAP"], incomeResult, '#82ca9d', '#fdba74', '#d1d5db');
    const { results: outcomeList, necessaryList: outcomeNecessaryList, unnecessaryList: outcomeUnnecessaryList } = getPieChartData(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OUTCOME_TYPE_MAP"], outcomeResult, '#faa5a5', '#fdba74', '#d1d5db');
    return {
        income: {
            total: totalIncome,
...
const getPieChartData = (types, data, resultColor, necessaryColor, unnecessaryColor)=>{
    const results = [];
    const necessaryList = [];
...
const parseData = (data)=>{
    const incomeResult = new Map();
    let totalIncome = 0;
    let necessaryIncome = 0;
    let unnecessaryIncome = 0;
    const outcomeResult = new Map();
    let totalOutcome = 0;
    let necessaryOutcome = 0;
    let unnecessaryOutcome = 0;
    data.forEach((record)=>{
        if (record.type === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SpendingType"].Income) {
            const category = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INCOME_TYPE_MAP"].find((d)=>d.value === record.category);
            if (category) {
                totalIncome += Number(record.amount);
                let temp = incomeResult.get(category.label) ?? getEmptyResult();
                if (record.necessity === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Necessity"].Need) {
            ...
            const category = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OUTCOME_TYPE_MAP"].find((d)=>d.value === record.category);
            if (category) {
...
"[project]/src/app/analysis/CostTable.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const CostTable = ({ title, total, list, options = {
    headerStyle: 'bg-gray-200'
} })=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex w-full flex-col gap-2 whitespace-nowrap",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                className: "font-semibold",
                children: title
            }, void 0, false, {
                fileName: "[project]/src/app/analysis/CostTable.tsx",
                lineNumber: 20,
                columnNumber: 7
            }, ("TURBOPACK compile-time value", void 0)),
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                    className: "border border-solid border-gray-300 border-r-transparent px-2 py-1 text-center",
                                    children: "類型"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/analysis/CostTable.tsx",
                                    lineNumber: 24,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                    className: "border border-solid border-gray-300 border-r-transparent px-2 py-1 text-right",
                                    children: "比例 (%)"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/analysis/CostTable.tsx",
                                    lineNumber: 27,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                    className: "border border-solid border-gray-300 px-2 py-1 text-right",
                                    children: "金額 (NTD)"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/analysis/CostTable.tsx",
                                    lineNumber: 30,
                        ...
                        children: list.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                        className: "col-span-1 border border-solid border-gray-300 p-2 text-center",
                                        children: item.name
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/analysis/CostTable.tsx",
                                        lineNumber: 41,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                        className: "col-span-1 border border-solid border-gray-300 p-2 text-end",
                                        children: [
                                            item.value === 0 ? 0 : (Math.round(item.value / total * 100) || 0).toFixed(0),
                                            "%"
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/app/analysis/CostTable.tsx",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                        className: "col-span-2 border border-solid border-gray-300 p-2 text-end",
                                        children: [
                                            "$",
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$normalizeNumber$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeNumber"])(item.value)
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/app/analysis/CostTable.tsx",
                                        lineNumber: 50,
...
_c = CostTable;
var _c;
__turbopack_context__.k.register(_c, "CostTable");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/app/analysis/ExpenseCostTable.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$normalizeNumber$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/normalizeNumber.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$analysis$2f$CostTable$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/analysis/CostTable.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/constants.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
...
;
;
const defaultOutcomeList = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OUTCOME_TYPE_MAP"].map(({ label: category })=>({
        name: category,
        value: 0
    }));
const defaultIncomeList = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INCOME_TYPE_MAP"].map(({ label: category })=>({
        name: category,
        value: 0
    }));
const ExpenseCostTable = (props)=>{
    _s();
    const [outcomeList, setOutcomeList] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(defaultOutcomeList);
    const [incomeList, setIncomeList] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(defaultIncomeList);
    const total = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ExpenseCostTable.useMemo[total]": ()=>props.totalIncome + props.totalOutcome
    }["ExpenseCostTable.useMemo[total]"], [
        props.totalIncome,
        props.totalOutcome
    ]);
    const outcomePercentage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ExpenseCostTable.useMemo[outcomePercentage]": ()=>props.totalOutcome * 100 / (total || 100)
    }["ExpenseCostTable.useMemo[outcomePercentage]"], [
        props.totalOutcome,
        total
    ]);
    const incomePercentage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ExpenseCostTable.useMemo[incomePercentage]": ()=>props.totalIncome * 100 / (total || 100)
    }["ExpenseCostTable.useMemo[incomePercentage]"], [
        props.totalIncome,
        total
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ExpenseCostTable.useEffect": ()=>{
            if (props.outcomeList.length > 0) {
                setOutcomeList({
                    "ExpenseCostTable.useEffect": (prevState)=>prevState.map({
                            "ExpenseCostTable.useEffect": (_d, index)=>({
                                    ..._d,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$analysis$2f$CostTable$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CostTable"], {
                title: `支出各項資訊 $${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$normalizeNumber$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeNumber"])(props.totalOutcome)}（${outcomePercentage.toFixed(0)}%）`,
                ...
                fileName: "[project]/src/app/analysis/ExpenseCostTable.tsx",
                lineNumber: 70,
                columnNumber: 7
            }, ("TURBOPACK compile-time value", void 0)),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$analysis$2f$CostTable$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CostTable"], {
                title: `收入各項資訊 $${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$normalizeNumber$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeNumber"])(props.totalIncome)}（${incomePercentage.toFixed(0)}%）`,
...
_s(ExpenseCostTable, "xlP3+nyuYQd61isLOcrOtPaCTrg=");
_c = ExpenseCostTable;
const __TURBOPACK__default__export__ = ExpenseCostTable;
var _c;
__turbopack_context__.k.register(_c, "ExpenseCostTable");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/app/analysis/NecessityCostTable.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const defaultNecessaryList = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OUTCOME_TYPE_MAP"].map(({ label: category })=>({
        name: category,
        value: 0
    }));
const NecessityCostTable = (props)=>{
    _s();
    const [necessaryList, setNecessaryList] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(defaultNecessaryList);
    const [unnecessaryList, setUnnecessaryList] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(defaultNecessaryList);
    const total = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NecessityCostTable.useMemo[total]": ()=>props.totalNecessary + props.totalUnnecessary
    }["NecessityCostTable.useMemo[total]"], [
        props.totalNecessary,
        props.totalUnnecessary
    ]);
    const unnecessaryPercentage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NecessityCostTable.useMemo[unnecessaryPercentage]": ()=>props.totalUnnecessary * 100 / (total || 100)
    }["NecessityCostTable.useMemo[unnecessaryPercentage]"], [
        props.totalUnnecessary,
        total
    ]);
    const necessaryPercentage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NecessityCostTable.useMemo[necessaryPercentage]": ()=>props.totalNecessary * 100 / (total || 100)
    }["NecessityCostTable.useMemo[necessaryPercentage]"], [
        props.totalNecessary,
        total
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NecessityCostTable.useEffect": ()=>{
            if (props.unnecessaryList.length > 0) {
                setUnnecessaryList({
                    "NecessityCostTable.useEffect": (prevState)=>prevState.map({
                            "NecessityCostTable.useEffect": (_d, index)=>({
                                    ..._d,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$analysis$2f$CostTable$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CostTable"], {
                title: `必要支出各項資訊 $${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$normalizeNumber$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeNumber"])(props.totalNecessary)}（${necessaryPercentage.toFixed(0)}%）`,
                ...
                fileName: "[project]/src/app/analysis/NecessityCostTable.tsx",
                lineNumber: 72,
                columnNumber: 7
            }, ("TURBOPACK compile-time value", void 0)),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$analysis$2f$CostTable$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CostTable"], {
                title: `額外支出各項資訊 $${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$normalizeNumber$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeNumber"])(props.totalUnnecessary)}（${unnecessaryPercentage.toFixed(0)}%）`,
...
_s(NecessityCostTable, "qSYFK0lHbKSwOGvKkdfkfrArILA=");
_c = NecessityCostTable;
const __TURBOPACK__default__export__ = NecessityCostTable;
var _c;
__turbopack_context__.k.register(_c, "NecessityCostTable");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/app/analysis/ChartBlock.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$analysis$2f$ChartContainer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/analysis/ChartContainer.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$calSpending2Chart$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/calSpending2Chart.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$analysis$2f$ExpenseCostTable$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/analysis/ExpenseCostTable.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$analysis$2f$NecessityCostTable$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/analysis/NecessityCostTable.tsx [app-client] (ecmascript)");
;
;
;
var _s = __turbopack_context__.k.signature();
...
;
;
const ExpensePieChart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/src/app/analysis/ExpensePieChart.tsx [app-client] (ecmascript, next/dynamic entry, async loader)"), {
    loadableGenerated: {
        modules: [
            "[project]/src/app/analysis/ExpensePieChart.tsx [app-client] (ecmascript, next/dynamic entry)"
        ]
    },
    ssr: false,
    loading: ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "mx-auto mt-15 aspect-square size-45 rounded-full bg-gray-200 p-1.5",
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "bg-background size-full rounded-full p-1.5",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "size-full rounded-full bg-gray-200 p-5",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "bg-background size-full rounded-full"
                    }, void 0, false, {
                        fileName: "[project]/src/app/analysis/ChartBlock.tsx",
                        lineNumber: 23,
                        columnNumber: 11
                    }, ("TURBOPACK compile-time value", void 0))
                }, void 0, false, {
...
_c = ExpensePieChart;
const NecessityPieChart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/src/app/analysis/NecessityPieChart.tsx [app-client] (ecmascript, next/dynamic entry, async loader)"), {
    loadableGenerated: {
        modules: [
            "[project]/src/app/analysis/NecessityPieChart.tsx [app-client] (ecmascript, next/dynamic entry)"
        ]
    },
    ssr: false,
    loading: ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
const ChartBlock = ()=>{
    ...
    const { data, syncData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$SpendingProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetSpendingCtx"])();
    ...
    const today = new Date();
    const dateHook = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useYearMonth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useYearMonth"])(today);
    const refreshData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChartBlock.useCallback[refreshData]": (_groupId, _year, _month)=>{
            const { startDate, endDate } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getStartEndOfMonth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStartEndOfMonth"])(new Date(Number(_year), Number(_month) - 1));
            syncData(_groupId, userData?.email, startDate.toISOString(), endDate.toISOString());
        }
    }["ChartBlock.useCallback[refreshData]"], [
        syncData,
        userData?.email
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChartBlock.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startTransition"])({
                "ChartBlock.useEffect": ()=>{
                    const filteredData = data.filter({
                        "ChartBlock.useEffect.filteredData": (record)=>`${new Date(record.date).getFullYear()}` === dateHook.year && `${new Date(record.date).getMonth() + 1}` === dateHook.month
                    }["ChartBlock.useEffect.filteredData"]);
                    setChartData((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$calSpending2Chart$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calSpending2Chart"])(filteredData));
                }
            }["ChartBlock.useEffect"]);
        }
    }["ChartBlock.useEffect"], [
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex w-full flex-col items-center gap-8 md:flex-row md:items-start",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$analysis$2f$ChartContainer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ChartContainer"], {
                        title: "收支類別比例",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "size-75",
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ExpensePieChart, {
                                        totalIncome: chartData.income.total,
                                        totalOutcome: chartData.outcome.total,
                                        list: [
                                            ...chartData.outcome.list,
                                            ...chartData.income.list
                                        ]
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/analysis/ChartBlock.tsx",
                                        lineNumber: 108,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$analysis$2f$ExpenseCostTable$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        totalIncome: chartData.income.total,
                                        totalOutcome: chartData.outcome.total,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$analysis$2f$ChartContainer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ChartContainer"], {
                        title: "支出類別比例（必要 vs 額外）",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex w-full flex-wrap justify-center gap-4",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "size-75",
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(NecessityPieChart, {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex flex-1 flex-col gap-4",
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$analysis$2f$NecessityCostTable$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(ChartBlock, "VXBlhADLtD049A6zNOUqw4isDlg=", false, function() {
    return [
...
__turbopack_context__.k.register(_c1, "NecessityPieChart");
__turbopack_context__.k.register(_c2, "ChartBlock");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_b2a9433c._.js.map